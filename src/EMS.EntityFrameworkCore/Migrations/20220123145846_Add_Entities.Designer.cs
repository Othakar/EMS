...
namespace EMS.Migrations
{
    ...
    [Migration("20220123145846_Add_Entities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EMS.Acts.Act", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("EMSActs", (string)null);
                });

            modelBuilder.Entity("EMS.CareStaffs.CareStaff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("EMSCareStaffs", (string)null);
                });

            modelBuilder.Entity("EMS.CareStaffs.Grade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("EMSGrades", (string)null);
                });

            modelBuilder.Entity("EMS.Citizens.Citizen", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("EMSCitizens", (string)null);
                });

            modelBuilder.Entity("EMS.Records.Record", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("EMSRecords", (string)null);
                });
            ...
            modelBuilder.Entity("EMS.Acts.Act", b =>
                {
                    b.HasOne("EMS.Records.Record", "ActRecord")
                        .WithMany("Acts")
                        .HasForeignKey("RecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ActRecord");
                });

            modelBuilder.Entity("EMS.CareStaffs.CareStaff", b =>
                {
                    b.HasOne("EMS.Citizens.Citizen", "Citizen")
                        .WithMany()
                        .HasForeignKey("CitizenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EMS.CareStaffs.Grade", "Grade")
                        .WithMany()
            ...
            modelBuilder.Entity("EMS.Records.Record", b =>
                {
                    b.HasOne("EMS.CareStaffs.CareStaff", "Caregiver")
                        .WithMany()
                        .HasForeignKey("IdCareStaff")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EMS.Citizens.Citizen", "CareFor")
                        .WithMany()
                        .HasForeignKey("IdCitizen")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CareFor");
